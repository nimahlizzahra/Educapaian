...
<body>
    <div class="container mt-5">
        <h2 class="text-center mb-4">Tambah Guru</h2>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('gurus.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="mata_pelajaran" class="form-label">Mapel Pelajaran</label>
                        <select class="form-control" id="mata_pelajaran" name="mata_pelajaran" required>
                            <option value="" disabled selected>Pilih Mata Pelajaran</option>
                            <option value="TJK (Teknik Jaringan Komputer)">TJK (Teknik Jaringan Komputer)</option>
                            <option value="PPLG (Pengembangan Perangkat Lunak Dan Gim)">PPLG (Pengembangan Perangkat Lunak Dan Gim)</option>
                            <option value="DS (Desain Grafis)">DS (Desain Grafis)</option>
                        </select>
                    </div>
