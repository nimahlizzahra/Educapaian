            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h4 class="text-white text-capitalize ps-3 text-center">Data Guru</h4> <!-- Tengahin judul -->
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-hover align-items-center mb-0">
                            <thead class="bg-light text-sm">
                                <tr class="text-center">
                                   <th class="text-uppercase text-secondary font-weight-bolder py-2">No</th>
                                    <th class="text-uppercase text-secondary font-weight-bolder py-2">NIP</th>
                                    <th class="text-uppercase text-secondary font-weight-bolder py-2">Nama Guru</th>
                                    <th class="text-uppercase text-secondary font-weight-bolder py-2">Mata Pelajaran</th>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                    <a href="{{ route('gurus.show', $guru->guruID) }}" class="btn btn-sm btn-info me-1">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>     
                                        <a href="{{ route('gurus.edit', $guru->guruID) }}" class="btn btn-sm btn-primary me-1">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form action="{{ route('gurus.destroy', $guru->guruID) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus capai siswa ini?')">
