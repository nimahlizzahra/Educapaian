...
<head>
  ...
  <title>Edit Pencapaian Siswa</title>
...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <!-- Form Edit Siswa -->
                <form action="{{ route('siswas.update', $siswa->siswaID) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label for="nisn" class="form-label">NISN</label>
                        <input type="number" id="nisn" name="nisn" class="form-control" value="{{ old('nisn', $siswa->nisn) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="kelas" name="kelas" class="form-control" required>
                            ...
                            <option value="10A" {{ old('kelas', $siswa->kelas) == '10A' ? 'selected' : '' }}>10A</option>
                            <option value="10B" {{ old('kelas', $siswa->kelas) == '10B' ? 'selected' : '' }}>10B</option>
                            <option value="10C" {{ old('kelas', $siswa->kelas) == '10C' ? 'selected' : '' }}>10C</option>
                            <option value="11A" {{ old('kelas', $siswa->kelas) == '11A' ? 'selected' : '' }}>11A</option>
                            <option value="11B" {{ old('kelas', $siswa->kelas) == '11B' ? 'selected' : '' }}>11B</option>
                            <option value="11C" {{ old('kelas', $siswa->kelas) == '11C' ? 'selected' : '' }}>11C</option>
                            <option value="12A" {{ old('kelas', $siswa->kelas) == '12A' ? 'selected' : '' }}>12A</option>
                            <option value="12B" {{ old('kelas', $siswa->kelas) == '12B' ? 'selected' : '' }}>12B</option>
                            <option value="12C" {{ old('kelas', $siswa->kelas) == '12C' ? 'selected' : '' }}>12C</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control" value="{{ old('email', $siswa->email) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="telepon" class="form-label">Telepon</label>
                        <input type="text" id="telepon" name="telepon" class="form-control" value="{{ old('telepon', $siswa->telepon) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat</label>
                        <textarea id="alamat" name="alamat" class="form-control" rows="3" required>{{ old('alamat', $siswa->alamat) }}</textarea>
                    </div>
