...
<body class="g-sidenav-show bg-gray-200">
  ...
  <div class="container mt-5">
    <h2 class="text-center mb-4">Tambah Data Pencapaian Siswa</h2>
  ...
  function updateBidang() {
    ...
    const jenisPrestasi = document.getElementById('jenis_prestasi');
    
    // Reset pilihan
    jenisPrestasi.innerHTML = '<option value="">-- Pilih Bidang --</option>';

    let options = [];

    if (kategori === 'Akademik') {
      options = ['Matematika', 'Bahasa Indonesia', 'Bahasa Inggris', 'IPA', 'IPS', 'Sains', 'Teknologi'];
    } else if (kategori === 'Non-Akademik') {
      options = ['Olahraga', 'Seni Tari', 'Seni Musik', 'Pramuka', 'Paskibra', 'Debat', 'Pidato'];
    }

    options.forEach(function(bidang) {
      const option = document.createElement('option');
      option.value = bidang;
      option.text = bidang;
      jenisPrestasi.appendChild(option);
    });
  }
</script>
