        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="siswaID" id="siswaID" class="form-control" required>
                            ...
                            @foreach($siswas as $siswa)
                                <option value="{{ $siswa->siswaID }}">{{ $siswa->nama_siswa }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jenis_prestasi" name="jenis_prestasi" placeholder="Masukkan Jenis Prestasi" required>
                    </div>

                    <div class="mb-3">
                        <label for="tanggal_raih_prestasi" class="form-label">Tanggal Pencapaian</label>
                        <input type="date" class="form-control" id="tanggal_raih_prestasi" name="tanggal_raih_prestasi" required>
                    </div>
