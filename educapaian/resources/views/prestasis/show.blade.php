      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            <h4 class="text-center">Detail Data Prestasi</h4>
          </div>
          <div class="card-body">
            <!-- Menampilkan Data Prestasi dalam Tabel -->
            ...
            <!-- Tombol Kembali -->
            <a href="{{ route('prestasis.index') }}" class="btn btn-primary">Kembali</a>
          </div>
        </div>
      </div>
    </div>
