            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h4 class="text-white text-capitalize ps-3 text-center">Data Siswa</h4> <!-- Tengahin judul -->
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <a href="{{ route('siswas.edit', $siswa->siswaID) }}" class="btn btn-sm btn-primary me-1">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form action="{{ route('siswas.destroy', $siswa->siswaID) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
