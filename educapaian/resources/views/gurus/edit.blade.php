...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <div class="collapse navbar-collapse w-auto max-height-vh-100">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white active bg-gradient-primary" href="{{ route('gurus.index') }}">
...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <!-- Form Edit Siswa -->
                <form action="{{ route('gurus.update', $guru->guruID) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="mb-3">
                        <label for="nip" class="form-label">NIP</label>
                        <input type="number" id="nip" name="nip" class="form-control" value="{{ old('nip', $guru->nip) }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="mata_pelajaran" name="mata_pelajaran" class="form-control" required>
                            <option value="TJK (Teknik Jaringan Komputer)" {{ old('mata_pelajaran', $guru->mata_pelajaran) == 'TJK (Teknik Jaringan Komputer)' ? 'selected' : '' }}>TJK (Teknik Jaringan Komputer)</option>
                            <option value="PPLG (Pengembangan Perangkat Lunak Dan Gim)" {{ old('mata_pelajaran', $guru->mata_pelajaran) == 'PPLG (Pengembangan Perangkat Lunak Dan Gim)' ? 'selected' : '' }}>PPLG (Pengembangan Perangkat Lunak Dan Gim)</option>
                            <option value="DS (Desain Grafis)" {{ old('mata_pelajaran', $guru->mata_pelajaran) == 'DS (Desain Grafis)' ? 'selected' : '' }}>DS (Desain Grafis)</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="telepon" name="telepon" class="form-control" value="{{ old('telepon', $guru->telepon) }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat</label>
                        <textarea id="alamat" name="alamat" class="form-control" rows="3" required>{{ old('alamat', $guru->alamat) }}</textarea>
                    </div>
